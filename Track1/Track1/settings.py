"""
Django settings for Track1 project.
...
SECRET_KEY = '+67y6x60&oa(fq#3gr3g41h3re=l_^(ao)5+x_cagq3k&p5_h_'
...
WSGI_APPLICATION = 'Track1.wsgi.application'
